            ...
            <div class="content">
               <div class="team row">
                  <div class="team-memeber col-md-6 col-lg-4 col-xl-3">
                     <div class="card">
                        <div class="TopImg">
                           <img src="<?php echo base_url(); ?>assets/photo/avatar51.png" class="rounded-circle w-100 d-block">
                        </div>
                        <div class="TeamInfo text-center">
                           <div class="Name"> PT. Pandu Raya Internusa</div>
                           <div class="bio">Seorang Mahasiswa Stmik Jakarta STI&K</div>
         ...
         <div class="container">
            <div class="row">
               <div class="col-12 text-center my-3">
                  Copyright &copy; PT. Pandu Raya Internusa  | Aplikasi Penggajian 2024 - All Rights Reserved
               </div>
            </div>
         </div>
      </div>
